...
Agents are naturally good at files. Copilot CLI works because bash + filesystem is the most battle-tested agent interface. When building agent-native apps, lean into this.

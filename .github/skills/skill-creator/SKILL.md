...
When editing the (newly-generated or existing) skill, remember that the skill is being created for another Copilot session to use. Focus on including information that would be beneficial and non-obvious to Copilot. Consider what procedural knowledge, domain-specific details, or reusable assets would help another Copilot session execute these tasks more effectively.

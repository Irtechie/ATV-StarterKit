...
2. `/kb-plan $ARGUMENTS` — **Record the plan file path** from `docs/plans/` for steps 4 and 6.
3. `/kb-work` — **Use swarm mode**: Make a Task list and launch an army of agent swarm subagents to build the plan
